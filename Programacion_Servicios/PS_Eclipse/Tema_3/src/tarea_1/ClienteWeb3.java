...
public class ClienteWeb3 {
	public static void main(String[] args) {
		...
		try {
			...
			pWriter.println("GET /img/a.png");
			pWriter.flush();
			int linea;
			byte listaBytes[] = new byte[4096];
			FileOutputStream escritorArchivo = new FileOutputStream("imagen_a.png");
			while ((linea = is.read(listaBytes)) != -1) {
				escritorArchivo.write(listaBytes, 0, linea);
			}
